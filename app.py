...
# ============================================================================
# MODAL DE VALIDACIÓN (SIN st.dialog)
# ============================================================================
...
if st.session_state.show_validation:
    ...
    with st.spinner("🔄 Ejecutando validación (puede tomar 1-2 minutos)..."):
        try:
            # ... [todo el código de validación que ya tienes en el modal] ...
            # (Mantén el código que está dentro del try/except)
            
            # IMPORTANTE: Al final del try, después de mostrar resultados, AÑADE:
